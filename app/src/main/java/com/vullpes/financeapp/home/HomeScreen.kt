...
import com.vullpes.financeapp.home.components.AccountsComponent
import com.vullpes.financeapp.home.components.TopAppBar
...
fun prevHomeScreeNight() {
    ...
    HomeScreen(
        uiState = UiStateHome(
            accountSelected = com.vullpes.account.domain.Account(
                1,
                "Casa",
            ...
            accounts = listOf(
                com.vullpes.account.domain.Account(
                    1,
                    "Casa",
                    accountBalance = 1500.00,
                    activeAccount = true,
            ...
            transactions = listOf(
                com.vullpes.transaction.Transaction(
                    transactionID = 1,
                    categoryID = 1,
                    name = "Transaction 1",
