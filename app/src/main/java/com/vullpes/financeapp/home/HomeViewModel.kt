...
class HomeViewModel @Inject constructor(
    private val getFlowUserUsecase: com.vullpes.authentication.usecases.GetFlowUserUsecase,
    private val logoutUsecase: com.vullpes.authentication.usecases.LogoutUsecase,
    private val clearAllSessionDataUsecase: com.vullpes.authentication.usecases.ClearAllSessionDataUsecase,
    private val checkIfCanWithdrawUsecase: com.vullpes.account.domain.usecases.account.CheckIfCanWithdrawUsecase,
    private val createTransactionUseCase: com.vullpes.transaction.usecases.CreateTransactionUseCase,
    private val buttonSaveTransactionEnabledUseCase: com.vullpes.transaction.usecases.ButtonSaveTransactionEnabledUseCase,
    private val getLastTransactionsByAccountUseCase: com.vullpes.transaction.usecases.GetLastTransactionsByAccountUseCase,
    private val listCategoryUseCase: com.vullpes.category.usecases.ListCategoryUseCase,
    private val listAccountUseCase: com.vullpes.account.domain.usecases.account.ListAccountUseCase,
    private val createAccountUseCase: com.vullpes.account.domain.usecases.account.CreateAccountUseCase,
    private val updateAccountUseCase: com.vullpes.account.domain.usecases.account.UpdateAccountUseCase,
    private val buttonSaveAccountEnabledUsecase: com.vullpes.account.domain.usecases.account.ButtonSaveAccountEnabledUsecase,
    private val checkIfAccountNameIsDifferentUsecase: com.vullpes.account.domain.usecases.account.CheckIfAccountNameIsDifferentUsecase,
    ...
    fun onOpenAccountModal(account: com.vullpes.account.domain.Account? = null) {
        uiState = if (account != null) {
            ...
            uiState.copy(accountCreateUpdate = com.vullpes.account.domain.Account(), openAccountModal = true, valueAccount = "")
        }
