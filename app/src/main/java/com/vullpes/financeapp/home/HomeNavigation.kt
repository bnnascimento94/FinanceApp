...
import com.vullpes.components.ModalBottomSheetAccount
import com.vullpes.components.ModalBottomSheetTransactions
...
fun NavGraphBuilder.homeRoute(
    ...
    composable(route = com.vullpes.util.navigation.Screen.Home.route) {
        ...
        HomeScreen(
            ...
            onDeposit = { accountID ->
                ...
                viewModel.onOpenModalTransacton(
                    accountID,
                    com.vullpes.util.domain.KindOfTransaction.DEPOSIT
                )
            },
            onWithdraw = { accountID ->
                ...
                viewModel.onOpenModalTransacton(
                    accountID,
                    com.vullpes.util.domain.KindOfTransaction.WITHDRAW
                )
            },
            onTransference = { accountID ->
                ...
                viewModel.onOpenModalTransacton(
                    accountID,
                    com.vullpes.util.domain.KindOfTransaction.TRANSFERENCE
                )
            },
            onCategoryClicked = {
                onInteraction()
